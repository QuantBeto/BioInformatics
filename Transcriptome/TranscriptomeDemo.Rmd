...
# the q-value is 0.999, the p-value is 0.390, ID is 1, fc is 17.808
...
# <it tells me the number of collumns>
```{r}
...
# There are not a lot of transcripts per gene. 
...
## interpret the above figure: The fold change frequency is close to 0 and the further away it is the lower the frequency. 
...
# the log2 for the biofil files is lower than the log2 for the planktonic files
