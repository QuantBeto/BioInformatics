...
# remove mitohondria and chloroplast matches. remove all non bacterial sequences 
```{r}
...
# barplot
# "body.site" can be changed into a different collumn to change the graph
...
# shannon gives more weight to rare speceis simpson doesnt 
```{r}
...
# Bray curtis Subject Statictics 
```{r}
